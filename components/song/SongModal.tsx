...
import { IconX, IconHeart, IconHeartFilled, IconMusic } from '@tabler/icons-react';
...
export default function SongModal({ song, onClose, onFavoriteToggle }: Props) {
  useEffect(() => {
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <button onClick={() => onFavoriteToggle(song.id, !song.favorited)} className="shrink-0 flex items-center gap-1.5 text-sm text-gray-500 hover:text-red-500 transition-colors">
              {song.favorited
